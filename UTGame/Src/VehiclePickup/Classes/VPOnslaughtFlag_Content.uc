class VPOnslaughtFlag_Content extends UTOnslaughtFlag_Content;
...
function bool ValidHolder(Actor other)
{
    ...
    // we don't want hoverboard to eat the orb, modify this condition from original since it 
    // conflicted with turning on bCanPickupInventory for vehicles
